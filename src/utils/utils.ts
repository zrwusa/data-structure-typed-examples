...
export class WaitManager {
    ...
    get time5(): number {
        return this._time5 / this._nXSpeed;
    }

    private _time6 = 6000;

    get time6(): number {
        return this._time6 / this._nXSpeed;
    }

    private _time7 = 7000;

    get time7(): number {
        return this._time7 / this._nXSpeed;
    }

    private _time8 = 8000;

    get time8(): number {
        return this._time8 / this._nXSpeed;
    }

    private _time9 = 9000;

    get time9(): number {
        return this._time9 / this._nXSpeed;
    }
